...
class Knock38Test < Minitest::Test
  def test_case_1
    # この参照する要素番号の配列要素の値を表示
    # 次にその配列要素の値を次の参照する要素番号
    # の次の参照する要素番号の配列要素の値を表示
    # さらにその配列要素の値を次の参照する要素番号
    ...
    assert_output(expect.chomp) { Knock38.execute }
  end
end
